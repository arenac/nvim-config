...
_G.packer_plugins = {
  harpoon = {
    loaded = true,
    path = "/home/nilo/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  playground = {
    loaded = true,
    path = "/home/nilo/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/home/nilo/.local/share/nvim/site/pack/packer/start/rose-pine",
    url = "https://github.com/rose-pine/neovim"
  },
  ["telescope.nvim"] = {
    loaded = true,
    path = "/home/nilo/.local/share/nvim/site/pack/packer/start/telescope.nvim",
